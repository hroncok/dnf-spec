...
- update release notes; change dnf version (Martin Hatina)
- repo: don't pass None value to librepo callback (RhBug:1387754) (Michal
  Luscon)
- Enable filtering for epoch=0 in _nevra_to_filters (RhBug:1229730) (Jaroslav
  Mracek)
- backported releasever logic from yum (RhBug:1375277) (Michael Mraka)
- Add support for newpackages for updateinfo (Jaroslav Mracek)
- Remove add types from option for updateinfo (Jaroslav Mracek)
- Enable security option filtering for updateinfo command (Jaroslav Mracek)
- Refactored _merge_update_filters() (Jaroslav Mracek)
- Add support for security options for repoquery command (Jaroslav Mracek)
- Add support for security options for info and list commands (Jaroslav Mracek)
- Add alias for check-update (Jaroslav Mracek)
- Add support for security options for check-update command (Jaroslav Mracek)
- Suppress all errors with --quiet option (RhBug:1384289) (Jaroslav Mracek)
- Add choices for arguments of check command. (Jaroslav Mracek)
- Make armv8l alias for armhfp (Miro Hrončok)
- Use the already open transaction handle for importing public keys
  (RhBug:1398272) (Panu Matilainen)
- updated <transaction-spec> description in documentation (Michael Mraka)
- updated history tests (Michael Mraka)
- removed other redundant functions to convert args to transaction ids (Michael
  Mraka)
- convert history arguments into transaction ids (Michael Mraka)
- subject: Check validity of nevra before usage (Pavel Grunt)
- Catch IOErrors on multiple sites (RhBug:1382224) (Jaroslav Mracek)
- Enable logging of KeyboardInterrupt (Jaroslav Mracek)
- Fix description of deplist option and command (Jaroslav Mracek)
- Fix query glob optimization after privatization (Jaroslav Mracek)
- Change file search for get_best_selector() (Jaroslav Mracek)
- Remove unused function _nevra_to_selector() (Jaroslav Mracek)
- Change provides search for get_best_selector() (Jaroslav Mracek)
- Change provides search for get_best_query() (Jaroslav Mracek)
- Change obsolete handling in get_best_selector() (RhBug:1177785) (Jaroslav
  Mracek)
- Change selector creation with glob pattern (Jaroslav Mracek)
- Add description of upgrade-minimal command (Jaroslav Mracek)
- Add def _has_just name() into subject (Jaroslav Mracek)
- Add support for security options for updateinfo (Jaroslav Mracek)
- Add new command upgrade-minimal (Jaroslav Mracek)
- Add description of security options in documentation (Jaroslav Mracek)
- Add filtering for security updates in upgrade() (RhBug:1272109) (Jaroslav
  Mracek)
- Add filtering for security updates in upgrade_all (Jaroslav Mracek)
- Add function that creates security update filters (Jaroslav Mracek)
- Add security options formally used by yum plus 2 (RhBug:1234930) (Jaroslav
  Mracek)
- Change incorrect information about repoquery and formating (Jaroslav Mracek)
- Change yum-vs-dnf documentation for deplist (Jaroslav Mracek)
- Add option --deplist for repoquery (Jaroslav Mracek)
- setup SideCI to ignore some PEP8 violations (Jan Silhan)
- Return 1 if TransactionCheckError during do_transaction() (Jaroslav Mracek)
- Change a description of API do_transaction (Jaroslav Mracek)
- Return 1 if verification fails (RhBug:1341086) (Jaroslav Mracek)
- use dnf cachedir (Martin Hatina)
- Make `dnf repoquery --unsatisfied` work again. (Nils Philippsen)
- KeyImport: Mark _confirm as private (Pavel Grunt)
- support custom commands (Martin Hatina)
- introduce tests for yum compatible layer (Martin Hatina)
- introduce yum compatible layer (Martin Hatina)
- conf: introduce 'check_config_file_age' option (Martin Hatina)
- Replace duplicated by duplicates (Jaroslav Mracek)
- Change query duplicated() (Jaroslav Mracek)
- Enhance output of check command (Jaroslav Mracek)
- Add unitests for check command (Jaroslav Mracek)
- Add description of `dnf check` command into documentation (Jaroslav Mracek)
- Change one filter for installonly pkgs. (Jaroslav Mracek)
- Add check command (Jaroslav Mracek)
- Add def to create query with installonly pkgs (RhBug:1382247) (Jaroslav
  Mracek)
- Fix option --nogpgcheck (RhBug:1381216) (Jaroslav Mracek)
- Remove unused def dnf.Base.install_groupie() (Jaroslav Mracek)
- Enable repo with repository-pkgs command (RhBug:1246211) (Jaroslav Mracek)
- zanata update (RhBug:1381432) (Jan Silhan)
- cosmetic: subject: fix ppep8 violations (Jan Silhan)
- subject: prefer obsoletes (RhBug:1096506)(RhBug:1332830) (Jan Silhan)
- fixed examples according to new plugin API (Michael Mraka)
- doc: correct release notes (Michal Luscon)
- doc: add information about 'type' option (Igor Gnatenko)
- repo: add 'rpm' as alias for 'rpm-md' (RhBug:1380580) (Igor Gnatenko)
- Solve problems with -l and -s options in repoquery (Jaroslav Mracek)
